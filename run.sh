cmake -DCMAKE_POLICY_VERSION_MINIMUM=3.5  -DPROJECT_SELECTOR=FALSE -DASSIMP_WARNINGS_AS_ERRORS=OFF -DASSIMP_BUILD_TESTS=OFF -DBUILD_SHARED_LIBS=OFF -S . -B ./build
cd build
make
